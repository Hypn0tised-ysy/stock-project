...
cd build
qmake.exe %PRO_DIR%\StockMarket.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=console"
if exist %BUILD_DIR%\debug\StockMarket.exe del %BUILD_DIR%\debug\StockMarket.exe
