...
public:
	...
	std::string get_name(Account *user);									  // ï¿½é¿´ï¿½Òµï¿½ï¿½Ë»ï¿½id
...
int time(int duration, int id);//¼ÆÊ±Æ÷£¬¡£¼ä¸ôÊ±¼ä£¬¶¨Î»µ½µÚ¼¸ºÅ¼ÆÊ±Æ÷(Ê¹ÓÃ·½·¨£¬µÚÒ»¸ö²ÎÊý´«¼ä¸ôÊ±¼ä(µ¥Î»ºÁÃë)£¬µÚ¶þ¸ö²ÎÊýÊäÈë¼¸ºÅ¼ÆÊ±Æ÷£¬ÏÖÔÚ¸ãÁËÊ®¸ö)
